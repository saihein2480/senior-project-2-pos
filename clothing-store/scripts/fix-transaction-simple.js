 ...
 * Run: node scripts/fix-transaction-simple.js TEST-ONL-178776768272-4IS9MQ
 */
...
if (!transactionId) {
  ...
  console.log('Usage: node scripts/fix-transaction-simple.js <TRANSACTION_ID>');
  console.log('Example: node scripts/fix-transaction-simple.js TEST-ONL-178776768272-4IS9MQ');
  process.exit(1);
}
